...
$stmt = mysqli_prepare($conn, "SELECT * FROM orderperbaikan WHERE nama = ? ORDER BY id DESC");
              ...
              <div class="text-right">
                <?php
                  ...
                  $bgColor = match($status) {
                    'menunggu teknisi' => 'bg-yellow-500',
                ...
                <p class="text-sm text-gray-600 mt-1">Teknisi: <?= htmlspecialchars($data["teknisi"]); ?></p>
              </div>
            </div>
            <hr class="my-4">
