                        ...
                        <?php else: ?>
                            <?php foreach ($orders as $order): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-700"><?= htmlspecialchars($order['teknisi'] ? $order['teknisi'] : '-'); ?></td>
                                    <td class="px-4 py-4 whitespace-nowrap text-sm">
                                        <form method="POST" action="dashboard_admin.php" class="inline-flex items-center" id="status_form_<?= $order['id']; ?>">
                                            ...
                                            <select name="new_status" id="status_select_<?= $order['id']; ?>" class="p-1 border border-gray-300 rounded-md text-xs focus:ring-yellow-500 focus:border-yellow-500">
                                                <option value="Sepatu Akan Segera Dijemput" <?= $order['status'] == 'Sepatu Akan Segera Dijemput' ? 'selected' : ''; ?>>Sepatu Akan Segera Dijemput</option>
                                                <option value="Sepatu Diantar Kembali ke Pelanggan" <?= $order['status'] == 'Sepatu Diantar Kembali ke Pelanggan' ? 'selected' : ''; ?>>Sepatu Diantar Kembali ke Pelanggan</option>
                                                <option value="Menunggu Konfirmasi" <?= $order['status'] == 'Menunggu Konfirmasi' ? 'selected' : ''; ?>>Menunggu Konfirmasi</option>
                                                <option value="Diproses" <?= $order['status'] == 'Diproses' ? 'selected' : ''; ?>>Diproses</option>
                                                <option value="Dalam Penanganan" <?= $order['status'] == 'Dalam Penanganan' ? 'selected' : ''; ?>>Dalam Penanganan</option>
                                    ...
                                    <td class="px-4 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex flex-col space-y-1">
                                            <a href="detail_pesanan_admin.php?id=<?= $order['id']; ?>" class="text-indigo-600 hover:text-indigo-900 text-xs" title="Lihat Detail">
